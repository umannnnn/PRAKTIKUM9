...
import com.example.praktikum9.Network.ApiClient
import com.example.praktikum9.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun Insert(view: View) {
        val intent = Intent(this, com.example.praktikum9.Fitur.Insert::class.java)
